...
UserGame.create!(user_id: 35, game_id: 10)
UserGame.create!(user_id: 36, game_id: 11)
UserGame.create!(user_id: 37, game_id: 12)
UserGame.create!(user_id: 32, game_id: 10)
UserGame.create!(user_id: 31, game_id: 11)
UserGame.create!(user_id: 30, game_id: 12)
UserGame.create!(user_id: 33, game_id: 10)
UserGame.create!(user_id: 34, game_id: 11)
UserGame.create!(user_id: 25, game_id: 10)
UserGame.create!(user_id: 27, game_id: 11)
UserGame.create!(user_id: 28, game_id: 12)
