...
UserGame.destroy_all
UserGame.create!(user_id: 35, game_id: 12)
UserGame.create!(user_id: 36, game_id: 13)
UserGame.create!(user_id: 37, game_id: 14)
UserGame.create!(user_id: 38, game_id: 12)
UserGame.create!(user_id: 39, game_id: 13)
